...
void print_diff_help(const char *prog_name) {
    ...
    printf("Modes:\n");
    printf("  (no args)             Workspace diff (upstream by default)\n");
    ...
    printf("  -h, --help            Show this help message\n");
    printf("\nExamples:\n");
    printf("  %s diff                     # What apply would change (upstream)\n", prog_name);
    printf("  %s diff --downstream        # What update would commit\n", prog_name);
    printf("  %s diff --all               # Both directions with headers\n", prog_name);
