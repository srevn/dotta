...
static git_repository *open_resolved_repo(char **repo_path_out) {
    ...
    dotta_error_t *err = resolve_repo_path(&repo_path);
    if (err) {
...
static int cmd_init_main(int argc, char **argv) {
    ...
    /* Execute command */
    dotta_error_t *err = cmd_init(&opts);
    if (err) {
        error_print(err, stderr);
        error_free(err);
        return 1;
...
static int cmd_apply_main(int argc, char **argv) {
    ...
    /* Execute command */
    dotta_error_t *err = cmd_apply(repo, &opts);
    free(profiles);
    git_repository_free(repo);
...
static int cmd_status_main(int argc, char **argv) {
    ...
    /* Execute command */
    dotta_error_t *err = cmd_status(repo, &opts);
    free(profiles);
    git_repository_free(repo);
...
static int cmd_list_main(int argc, char **argv) {
    ...
    /* Execute command */
    dotta_error_t *err = cmd_list(repo, &opts);
    git_repository_free(repo);
...
static int cmd_diff_main(int argc, char **argv) {
    ...
    /* Execute command */
    dotta_error_t *err = cmd_diff(repo, &opts);
    free(files);
    git_repository_free(repo);
...
static int cmd_clean_main(int argc, char **argv) {
    ...
    /* Execute command */
    dotta_error_t *err = cmd_clean(repo, &opts);
    git_repository_free(repo);
...
static int cmd_clone_main(int argc, char **argv) {
    ...
    /* Execute command */
    dotta_error_t *err = cmd_clone(&opts);
    if (err) {
        error_print(err, stderr);
        error_free(err);
        return 1;
...
static int cmd_update_main(int argc, char **argv) {
    ...
    /* Execute command */
    dotta_error_t *err = cmd_update(repo, &opts);
    free(files);
    free(profiles);
    git_repository_free(repo);
...
static int cmd_ignore_main(int argc, char **argv) {
    ...
    /* Execute command */
    dotta_error_t *err = cmd_ignore(repo, &opts);
    git_repository_free(repo);
...
static int cmd_sync_main(int argc, char **argv) {
    ...
    /* Execute command */
    dotta_error_t *err = cmd_sync(repo, &opts);
    free(profiles);
    git_repository_free(repo);
...
static int cmd_remote_main(int argc, char **argv) {
    ...
    /* Execute command */
    dotta_error_t *err = cmd_remote(repo, &opts);
    git_repository_free(repo);
...
static int cmd_show_main(int argc, char **argv) {
    ...
    /* Execute command */
    dotta_error_t *err = cmd_show(repo, &opts);
    git_repository_free(repo);
...
static int cmd_revert_main(int argc, char **argv) {
    ...
    /* Execute command */
    dotta_error_t *err = cmd_revert(repo, &opts);
    git_repository_free(repo);
