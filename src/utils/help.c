...
void print_profile_help(const char *prog_name) {
    ...
    printf("  4. Select as needed:   %s profile select <name>\n", prog_name);
    ...
    printf("  %s profile select darwin              # Select for use\n", prog_name);
    printf("  %s profile select fish zsh tmux       # Select multiple\n", prog_name);
    printf("  %s profile unselect --all             # Unselect everything\n", prog_name);
